...
updateTime: '2024-05-14T09:26:00.000Z'
sort: ''
catalog: []
status: 已发布
  ...
  cats.forEach((e, i)=>{
    ...
    $itemCard.forEach((ee, ii)=>{
      ...
      if(extraData[id]){
        ...
        let $aLinkContactMainComputer = document.createElement('a');
        $aLinkContactMainComputer.setAttribute('class', 'ui button main-contact-computer '+ remainingAnimatedType +' animated blue');
        $aLinkContactMainComputer.setAttribute('target', '_blank');
        $aLinkContactMainComputer.innerHTML = '<div class="hidden content" style="padding:0;" title="剩余价值">'+ priceUnit + remainingPrice +'</div><div class="visible content" style="padding:0;" title="剩余价值">'+ contacts[mainContact].label +'</div>';
        $aLinkContactMainComputer.href = contacts[mainContact].url;
        $aLinkButtons.append($aLinkContactMainComputer);
        let $aLinkContactMainMobile = document.createElement('a');
        $aLinkContactMainMobile.setAttribute('class', 'ui button main-contact-mobile blue');
        $aLinkContactMainMobile.setAttribute('target', '_blank');
        $aLinkContactMainMobile.innerHTML = '<div class="hidden content" style="padding:0;" title="剩余价值"><i class="'+ contacts[mainContact].icon +' icon" style="color:white;"></i>'+ priceUnit + remainingPrice +'</div>';
        $aLinkContactMainMobile.href = contacts[mainContact].url;
        $aLinkButtons.append($aLinkContactMainMobile);
...
![QQ%E6%88%AA%E5%9B%BE20240514124407.png](https://image.bmqy.net/upload/46257b0e0cb77c745b136f0f89604d73.png)

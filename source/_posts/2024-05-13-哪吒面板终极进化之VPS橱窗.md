...
updateTime: '2024-05-16T06:28:00.000Z'
sort: ''
catalog: []
status: 已发布
...
let preferredTheme = document.cookie.match(/(server-status|default)/g) ? document.cookie.match(/(server-status|default)/g)[0] : 'default';
// 默认主题
